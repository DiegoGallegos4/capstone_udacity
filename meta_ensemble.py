...
# Parameters
FUDGE_FACTOR = 1.0300  # Multiply forecasts by this
...
# placeholder value for preliminary version
...
exc = [train.columns[c] for c in range(len(train.columns)) if train.dtypes[
    c] == 'O'] + ['logerror', 'parcelid']
